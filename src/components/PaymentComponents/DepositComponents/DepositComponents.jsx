...
export default function WalletDepositInterface() {
  ...
  const handleGoToPaymentPage = () => {
    ...
    if (!paymentChannel) {
      setError("Please select a payment channel above");
      return;
    }
        ...
        <Card sx={{ borderRadius: 3, boxShadow: 3 }}>
          <CardContent>
            ...
            <Button
              ...
              disabled={!amount || !paymentChannel || !!error || success}
              sx={{
                py: 1,
                fontSize: "1.1rem",
                fontWeight: "bold",
                ...
                "&:hover": {
                  background:
                    "linear-gradient(45deg, #1976D2 30%, #1BA5D2 90%)",
                },
                "&:disabled": {
                  background: "#e0e0e0",
                },
