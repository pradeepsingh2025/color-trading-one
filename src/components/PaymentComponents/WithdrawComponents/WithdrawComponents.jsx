...
const WalletWithdraw = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("http://localhost:3001/api/user/withdrawal", {
        method: "POST",
        headers: {
      ...
      <Container maxWidth="md" sx={{ py: 4 }}>
        <Card sx={{ textAlign: "center", p: 4, borderRadius: 3, boxShadow: 3 }}>
          ...
          {successMessage.includes("error") ? (
            <Typography>
              Sorry for inconvenience, please contact customer-service team.
            </Typography>
          ) : (
            <Typography variant="body1" sx={{ mb: 3 }}>
              Money will be credited to your account in the next 48 working
              hours. Contact customer-service team in case of any inconvenience.
            </Typography>
          )}
  ...
  return (
    <Container
      maxWidth="md"
      sx={{ py: 4, bgcolor: "#f5f5f5", my: "20px", p: 3, minHeight: "100vh" }}
    >
      <Typography
        variant="h4"
        gutterBottom
          ...
          <Card sx={{ height: "100%", borderRadius: 3, boxShadow: 3 }}>
            <CardContent sx={{ p: 3 }}>
              ...
              <Stack spacing={2}>
                ...
                <Typography variant="body2" color="text.secondary">
                  • If your information is incorrect, please contact customer
                  service
                </Typography>
              </Stack>
            </CardContent>
            ...
            <Box sx={{ display: "flex", gap: 3, mb: 3, flexWrap: "wrap" }}>
              ...
              <Box sx={{ flex: 1, minWidth: "250px" }}>
                <TextField
                  ...
                  InputProps={{
                    startAdornment: (
                      <Typography sx={{ mr: 1, color: "action.active" }}>
                        ₹
                      </Typography>
                    ),
                  }}
            ...
            {!isSubmitDisabled && (
              <Alert severity="info" sx={{ mt: 3 }}>
                <Typography variant="body2">
                  <strong>Amount to withdraw:</strong> ₹{withdrawAmount}
                  <br />
                  <strong>Remaining balance:</strong> ₹
                  {walletBalance - (parseFloat(withdrawAmount) || 0)}
                </Typography>
              </Alert>
            )}
          </CardContent>
